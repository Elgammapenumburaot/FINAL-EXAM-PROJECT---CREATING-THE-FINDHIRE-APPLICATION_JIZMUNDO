...
require_once 'core/models.php';  // Include models with getHRUsers
...
$hrUsers = getHRUsers($_SESSION['user_id']); // Get list of HR users
?>

<!DOCTYPE html>
<link rel="stylesheet" href="applicant_messages.css">
<html lang="en">
<head>
    <meta charset="UTF-8">
